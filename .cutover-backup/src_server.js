...
app.get('/v1/fred/:series_id', require402Payment('/v1/fred/{series_id}', (req) => {
...

{
  ...
  <pre><code>curl https://mercury402.uk/v1/fred/UNRATE \\
  -H "payment-signature: &lt;base64_x402_payment_payload&gt;"</code></pre>
  <pre><code>curl https://mercury402.uk/v1/treasury/yield-curve/daily-snapshot \\
  -H "payment-signature: &lt;base64_x402_payment_payload&gt;"</code></pre>
